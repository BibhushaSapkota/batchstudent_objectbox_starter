...
final _entities = <ModelEntity>[
  ModelEntity(
      id: const IdUid(1, 3216279941685156610),
      name: 'Batch',
      lastPropertyId: const IdUid(2, 7417864927115439286),
      flags: 0,
      properties: <ModelProperty>[
        ModelProperty(
            id: const IdUid(1, 3096570280912161261),
            name: 'batchId',
            type: 6,
            flags: 129),
        ModelProperty(
            id: const IdUid(2, 7417864927115439286),
            name: 'batchName',
            type: 9,
            flags: 0)
      ],
  ...
  ModelEntity(
      id: const IdUid(2, 6766504753188273010),
      name: 'Student',
      lastPropertyId: const IdUid(6, 5795966648229474934),
      flags: 0,
      properties: <ModelProperty>[
        ModelProperty(
            id: const IdUid(1, 787139284688301098),
            name: 'stdId',
            type: 6,
            flags: 129),
        ModelProperty(
            id: const IdUid(2, 6043098796964997973),
            name: 'fname',
            type: 9,
            flags: 0),
        ModelProperty(
            id: const IdUid(3, 6523666133823869125),
            name: 'lname',
            type: 9,
            flags: 0),
        ModelProperty(
            id: const IdUid(4, 2808927416645241615),
            name: 'username',
            type: 9,
            flags: 0),
        ModelProperty(
            id: const IdUid(5, 2728064633595111515),
            name: 'password',
            type: 9,
            flags: 0),
        ModelProperty(
            id: const IdUid(6, 5795966648229474934),
            name: 'batchId',
            type: 11,
            flags: 520,
            indexId: const IdUid(1, 4213981837307665680),
...
ModelDefinition getObjectBoxModel() {
  final model = ModelInfo(
      entities: _entities,
      lastEntityId: const IdUid(4, 3779665389009679399),
      lastIndexId: const IdUid(2, 5422242891634342085),
      lastRelationId: const IdUid(1, 6366813913146766083),
      lastSequenceId: const IdUid(0, 0),
      retiredEntityUids: const [4791328111456589042, 3779665389009679399],
      ...
      retiredRelationUids: const [6366813913146766083],
      modelVersion: 5,
